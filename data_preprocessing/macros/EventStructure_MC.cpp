...
int main(int argc, char **argv) {
  ...
  t.Add("/media/guang/Elements/LANL/FHC_*root");
  //t.Add("/media/guang/Elements/LANL/FHC_53_24x8x48_wFiber_wDead_realSize_wTyvek_noGap_centerX0.5_Y0.5_traj3_5e4each.root");
...
*/
  ...
  TFile wfile(Form("LANL_MC_24x8x48_wFiber_wDead_realSize_wTyvek_noGap_traj3_centerX0.5_Y0.5_extended5times_r%f.root",atof(argv[1])), "recreate");
  //TFile wfile ("test.root", "recreate");
  //TFile wfile(Form("LANL_MC_24x8x48_wFiber_wDead_realSize_wTyvek_noGap_traj3_centerX0.5_Y0.5_r%f.root",atof(argv[1])), "recreate");
  //TFile wfile(Form("LANL_MC_noDead_chunk_traj3_v2_centerX0.5_Y0.5_r%f.root",atof(argv[1])), "recreate");
  ...
  for(Int_t subSpill = 0; subSpill< t.GetEntries(); subSpill++){
    ...
    */
    ...
    int sameCube = 0;
    double hh1 = ((neutronHitX[hitLoop]+ 1.026*12. ) + 0.0001)/cubeSize;
    double hh2 = ((neutronHitY[hitLoop]+ 1.026*4. )  + 0.0001)/cubeSize;
    double hh3 = ((neutronHitZ[hitLoop]+ 1.026*24. ) + 0.0001)/cubeSize;
    if (hh3<0) {cout<<"ah!! "<<neutronHitZ[hitLoop]<<" "<<hh3<<endl;exit(0);}
    ...
    //aveY -= yy;
    //aveZ -= zz;
    //if (aveX <0 || aveX> xx*2 || aveY < 0 || aveY > yy*2 || aveZ<0 || aveZ > zz*2) continue;
