...
int main(int argc, char **argv) {
  ...
  t.Add("~/work/sfgd_framework/data_preprocessing/LANL2020/FHC_*_34cmTransverseGap_traj3.root");
  ...
  //t.Add("~/work/sfgd_framework/data_preprocessing/build/neutron/FHC_3*_noDead_chunk_traj3_centerX0.5_Y0.5.root");
...
*/
  ...
  TFile wfile(Form("LANL_MC_34cmTransverseGap_traj3_r%f.root",atof(argv[1])), "recreate");
...
*/
      ...
      if ((int)neutronHitX[locSave]%2 == 0) {
        xNphot = Nphot * ( a*exp((-(TMath::Abs(aveXSave-xxx))-d)/LongAtt) + (1-a)*exp((-(TMath::Abs(aveXSave-xxx))-d)/ShortAtt) );
        yNphot = Nphot * ( a*exp((-(TMath::Abs(aveYSave-yyy))-d)/LongAtt) + (1-a)*exp((-(TMath::Abs(aveYSave-yyy))-d)/ShortAtt) );
        zNphot = Nphot * ( a*exp((-(TMath::Abs(aveZSave-zzz))-d)/LongAtt) + (1-a)*exp((-(TMath::Abs(aveZSave-zzz))-d)/ShortAtt) );
        xTimeDelay =  timeSave+(1./speedInFiber) * TMath::Abs(aveXSave-xxx);
        yTimeDelay =  timeSave+(1./speedInFiber) * TMath::Abs(aveYSave-yyy);
        zTimeDelay =  timeSave+(1./speedInFiber) * TMath::Abs(aveZSave-zzz);
      }
      else {
        xNphot = Nphot * ( a*exp((-(TMath::Abs(aveXSave-xxx))-d)/LongAtt) + (1-a)*exp((-(TMath::Abs(aveXSave-xxx))-d)/ShortAtt) );
        yNphot = Nphot * ( a*exp((-(TMath::Abs(aveYSave-yyy))-d)/LongAtt) + (1-a)*exp((-(TMath::Abs(aveYSave-yyy))-d)/ShortAtt) );
      ...
      if(aveXSave+24<134 && aveYSave+24<100 && aveZSave+50< 101 && veryTempT< 10000){
        //cubeFlag[aveXSave+24] = 1;
        //cubeFlag2[aveYSave+24] = 1;
        //cubeFlag3[aveZSave+50] = 1;
        //cubeFlag4[veryTempT]  = 1;  
    ...
    // five digits: first two: baseline ; next three: rotation 
