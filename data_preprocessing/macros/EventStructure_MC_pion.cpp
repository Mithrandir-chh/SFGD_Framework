...
int main(int argc, char **argv) {
  ...
  //t.Add("~/work/sfgd_framework/data_preprocessing/build/neutron/FHC_*_24x8x48_wFiber_wDead_realSize_wTyvek_noGap_realRot_0_traj3_centerX0.5_Y0.5.root");
...
*/
  ...
  //TFile wfile(Form("LANL_MC_normalSize_v1_noRot_0_r%f.root",atof(argv[1])), "recreate");
  //TFile wfile("LANL_MC_normalSize_pencilBeam_100MeV.root", "recreate");
  TFile wfile("LANL_MC_pion_flag.root","recreate");

  //loop over spills
  for (Int_t subSpill = 0; subSpill<t.GetEntries()/10; subSpill++) {
