...
class MDdataWordBM : public MDdataWord {
 ...
 public:
  ...
  enum DWBMDataType { //hex  4bits
   SpillHeader   = 0x0,  //0000
   TrigHeader    = 0x1,  //0001
   TimeMeas      = 0x2,  //0010
   ChargeMeas    = 0x3,  //0011
   TrigTrailer1  = 0x4,  //0100
   TrigTrailer2  = 0x5,  //0101
   SpillTrailer1 = 0x6,  //0110
   SpillTrailer2 = 0x7,  //0111
   TDM           = 0xE,  //1110
   SpecialWord   = 0xF   //1111
  };
 ...
 private:
  ...
  enum DWBMMask {         //32bits
   DataTypeMask         = 0xF0000000, //11110000000000000000000000000000
   SidMask              = 0x000C0000, //00000000000011000000000000000000
   BoardIdMask          = 0x0FE00000, //00001111111000000000000000000000
   SpillTagMask         = 0x0000FFFF, //00000000000000001111111111111111
   SpillTimeMask        = 0x0FFFFFFF, //00001111111111111111111111111111

   SpillTimeGTRIGMask   = 0x000007FF, //00000000000000000000011111111111
   SpillDAQTypeMask     = 0x00038000, //00000000000000111000000000000000
   SpillHeadIdMask      = 0x00100000, //00000000000100000000000000000000
