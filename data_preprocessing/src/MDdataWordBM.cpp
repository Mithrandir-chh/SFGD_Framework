...
//takes the first 4 bits of a 32 bit word, shifts it to the right by 28 bits to end up with a 4 bit word corresponding to the header
...
ostream & operator<<(ostream &s, MDdataWordBM &dw) {
  ...
  s << " BM FEB ";
  switch (dt) {
  case MDdataWordBM::SpillHeader:  //if the 4 bit header = 0000 it's a spill header
